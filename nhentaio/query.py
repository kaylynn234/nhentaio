...
class Query:
    ...
    def pages(self, exact = None, *, less_than = None, more_than = None):
        ...
        Parameters
        -----------
        exact: Optional[Union[`nhentaio.Hours`, `nhentaio.Days`, `nhentaio.Weeks`, `nhentaio.Months`, `nhentaio.Years`]]
            Limits the search results to galleries uploaded in the last _.
        less_than: Optional[Union[`nhentaio.Hours`, `nhentaio.Days`, `nhentaio.Weeks`, `nhentaio.Months`, `nhentaio.Years`]]
            Limits the search results to galleries uploaded less than _ ago.
        more_than: Optional[Union[`nhentaio.Hours`, `nhentaio.Days`, `nhentaio.Weeks`, `nhentaio.Months`, `nhentaio.Years`]]
